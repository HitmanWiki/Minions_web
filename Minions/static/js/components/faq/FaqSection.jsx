...
class FaqSection extends React.Component {
    constructor(props){
        ...
        this.state = { 
            data: [
                { id: 1, title: "What is kek?", decscription: "A Deflationary Token on Ethereum with a PC-Game Interface and an Innovative NFT Ecosystem, with 4% Ethereum Reward to Holders"},
                ...
                { id: 4, title: "There is no Sell or Buy Limit", decscription: "Yes you can stak your $Kata soon. We are working on that Staking Mechanism and will soon provide Details"},
